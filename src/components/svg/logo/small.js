...
export default function small(props) {
	...
	return (
		...
		<rect x="13.7" y="53.2" className={first} width="27.4" height="3.3"/>
		<g>
			<path className={second} d="M29,47.7C24.4,48.3,20.5,47,17,44c-2.9-2.5,0.4-3.5,1.3-4.9c1.3-2.2,2.2-0.5,3.1,0.5c0.3,0.3,0.7,0.6,1,0.9
			...
			<path className={first} d="M24.4,47.7c-4.5,0.6-8.5-0.7-11.9-3.6c-3-2.5,0.4-3.5,1.2-4.9c1.3-2.2,2.2-0.5,3.1,0.5c0.3,0.3,0.7,0.6,1,0.9
